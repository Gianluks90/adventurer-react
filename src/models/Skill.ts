export class Skill {
    ...
    static newBasicSkills(): Skill[] {
        return [
            ...
            { name: 'investigation', label: 'Investigare', ability: 'intelligence', proficent: false, mastery: false },
            ...
            { name: 'performance', label: 'Esibizione', ability: 'charisma', proficent: false, mastery: false },
